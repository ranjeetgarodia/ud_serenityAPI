...
public class StudentCRUDTest2 extends TestBase{
	...
	public void tc001() {
		...
		step.createStudent(firstName, lastName, email, programme, courses).statusCode(201);
	...
	public void tc003() {
		...
		step.updateStudentInfo(studentId, firstName, lastName, email, programme, courses);
